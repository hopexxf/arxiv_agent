...
PAPERS_JSON = BASE_DIR / "data" / "papers.json"
...
def main() -> None:
    ...
    # 1. 先收集已在 papers_list 中的论文 ID（从 display_papers + overflow_detailed）
    papers_ids = {p["arxiv_id"] for p in all_papers}
    ...
    # 3. 添加 overflow_detailed 中的论文（去重）
    seen_ids = {o.get("arxiv_id", "") for o in overflow}
